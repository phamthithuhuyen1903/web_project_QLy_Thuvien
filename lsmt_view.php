...
<body>
    <div class="container">
        ...
        <div class="search-bar">
            <form action="lsmt_process.php" method="GET">
                <input type="text" name="search" placeholder="Mã SV hoặc Họ tên..." value="<?php echo htmlspecialchars($search); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    ? date('d/m/y', strtotime($row['NGAYTRATHUCTE'])) 
