...
if (isset($_POST['action']) && $_POST['action'] == "delete") {
    ...
    $check_sql = "SELECT COUNT(*) as total FROM sach WHERE ma_tg = ?";
...
<div class="thanhdieuhuong">
    ...
    <a href="/Project_QuanLyThuVien/librarian_book/php/author.php" class="thanhdieuhuong_btn active">
